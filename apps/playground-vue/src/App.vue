...
import type { ShellSidenavMode } from "@tulpar-ui/vue";
...
/**
 * Topbar brand-icon menu button → re-dispatch the shell's menu-toggle event from
 * the button element so it bubbles (composed) up to <tulpar-shell>, matching what
...
<template>
  ...
  >
    <!-- ── Topbar ───────────────────────────────────────────────────────── -->
    <TulparTopbar slot="topbar" :show-menu-button="false">
      <div slot="start" class="topbar-start">
        ...
        <span class="topbar-tag">Vue playground</span>
      </div>
      <button
        slot="end"
        type="button"
    ...
    >
      ...
      <!-- Components -->
      <TulparNavSection label="Components">
        <TulparNavItem label="Button" href="/button">
          <svg slot="icon" class="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
            <rect x="3" y="8" width="18" height="8" rx="4" />
            <path d="M7 12h4" stroke-width="1.6" />
          </svg>
        </TulparNavItem>
        <TulparNavItem label="TextInput" href="/text-input">
          <svg slot="icon" class="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
            <rect x="3" y="7" width="18" height="10" rx="2" />
            <path d="M8 12h.01" />
          </svg>
        </TulparNavItem>
        <TulparNavItem label="Textarea" href="/textarea">
          <svg slot="icon" class="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
            <rect x="3" y="5" width="18" height="14" rx="2" />
            <path d="M7 9h10M7 13h7" />
          </svg>
        </TulparNavItem>
        <TulparNavItem label="NumberInput" href="/number-input">
          <svg slot="icon" class="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
            <rect x="3" y="7" width="18" height="10" rx="2" />
      ...
      <!-- Foundations -->
      <TulparNavSection label="Foundations">
        <TulparNavItem label="Colors" href="/colors">
          <svg slot="icon" class="nav-icon" viewBox="0 0 24 24" aria-hidden="true">
