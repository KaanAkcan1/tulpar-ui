...
@Component({
  ...
  template: `
    ...
    <section class="doc-section">
      <h2 class="section-title">1. Fallback cascade</h2>
    ...
    <!-- ── 2. Broken image ────────────────────────────────────────────────── -->
    <section class="doc-section">
      <h2 class="section-title">2. Broken / missing image</h2>
      <p class="section-desc">
    ...
    <section class="doc-section">
      <h2 class="section-title">3. Deterministic color</h2>
      <p class="section-desc">
    ...
    <!-- ── 6. Avatar group ────────────────────────────────────────────────── -->
    <section class="doc-section">
      <h2 class="section-title">6. Overlapping group</h2>
      <p class="section-desc">
    ...
    <!-- ── 7. Prop vs slot — default content ──────────────────────────────── -->
    <section class="doc-section">
      <h2 class="section-title">7. Content — default (prop &amp; slot)</h2>
      <p class="section-desc">
